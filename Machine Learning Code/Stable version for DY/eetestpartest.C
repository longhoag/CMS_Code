...
void eetestpartest(Int_t ntrain = 1000) {
...
//--type signal and background: 1-signal, 0-background
   ...
   //-- train NN
   TMultiLayerPerceptron *mlp = new TMultiLayerPerceptron("@pt1,@eta1,@phi1,@pt2,@eta2,@phi2,@Nak8j,@missET:12:6:3:type",simu,"Entry$%2", "(Entry$+2)%2");   
...
//--feeding to NN
   ...
   MLPee-> Scale(100/MLPee->GetEntries());
   MLPeeb-> Scale(100/MLPeeb->GetEntries());
