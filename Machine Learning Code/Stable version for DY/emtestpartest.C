...
void emtestpartest(Int_t ntrain = 200) {
...
//--type signal and background: 1-signal, 0-background
   ...
   //-- train NN
   TMultiLayerPerceptron *mlp = new TMultiLayerPerceptron("@pt1,@eta1,@phi1,@pt2,@eta2,@phi2,@Nak8j,@missET:12:6:4:type",simu,"Entry$%2", "(Entry$+2)%2");   
