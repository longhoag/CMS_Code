...
//-- simu branch
   ...
   // simu->Branch("pt1b",   &pt1b,   "pt1b/F");
   // simu->Branch("eta1b",  &eta1b,  "eta1b/F");
   // simu->Branch("phi1b",  &phi1b,  "phi1b/F");
   // simu->Branch("pt2b",   &pt2b,   "pt2b/F");
   // simu->Branch("eta2b",  &eta2b,  "eta2b/F");
   // simu->Branch("phi2b",  &phi2b,  "phi2b/F");
   // simu->Branch("Nak8jb", &Nak8jb, "Nak8jb/F");
   // simu->Branch("missETb",&missETb,"missETb/F");
